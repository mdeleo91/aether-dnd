...
export const Dragon = make(
  <>
    <path d="M3 6c2-.5 3.5.3 4.5 2" />
    <path d="M12 4c3.3 0 6.3 2.1 7.2 5.2.9 3.1-.8 6.3-4 7.4-1.2.4-2.5.5-3.8.4" />
    <path d="M12 17c-3 1-5.5.3-7-2 .8-1.6 2.3-2.2 3.8-1.6" />
    <path d="M20.5 9.5 22 8M20 13l2 .4M15.5 8.2h.01" />
  </>,
)
